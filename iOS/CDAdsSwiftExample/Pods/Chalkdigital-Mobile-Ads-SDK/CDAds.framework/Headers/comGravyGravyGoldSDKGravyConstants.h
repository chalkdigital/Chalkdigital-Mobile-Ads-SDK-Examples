 ...
 *
 *
 * Copyright (c) 2015 Gravy. All rights reserved.
 */

#import <Foundation/Foundation.h>

/**
 * Keeps track of GravySDK constants
 */
@interface comGravyGravyGoldSDKGravyConstants : NSObject


/**
 * Current version the SDK is running on.
 */
